...
5. **Contact form**: Resend only — no DB persistence. Honeypot + rate limit. PHI disclaimer. `replyTo` = submitter. From-address on verified subdomain `mail.stefanie-schumacher.com`.
